...
from app.domain.events import PROSPECTS_PROSPECT_CREATED_V1
...
def create_prospect(
    ...
    publish_event(
        PROSPECTS_PROSPECT_CREATED_V1["topic"],
        {
            "eventType": PROSPECTS_PROSPECT_CREATED_V1["type"],
            "eventVersion": 1,
            "prospectId": prospect_id,
            **prospect_data,
            "occurredAt": now,
        },
        {"eventType": PROSPECTS_PROSPECT_CREATED_V1["type"], "businessId": business_id},
    )
