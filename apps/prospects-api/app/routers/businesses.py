...
@router.get("/platform/businesses/{id}/items")
def list_items(
    id: str,
    _: Annotated[UserContext, Depends(require_super_admin())] = None,
):
...
@router.post("/platform/businesses/{id}/items")
def add_item(
    id: str,
    item: dict,
    _: Annotated[UserContext, Depends(require_super_admin())] = None,
...
@router.patch("/platform/businesses/{id}/items/{item_id}")
def update_item(
    id: str,
    item_id: str,
    patch: dict,
...
@router.delete("/platform/businesses/{id}/items/{item_id}")
def delete_item(
    id: str,
    item_id: str,
    _: Annotated[UserContext, Depends(require_super_admin())] = None,
...
@router.post("/platform/businesses/{id}/{action}")
def business_action(
    id: str,
    action: str,
    _: Annotated[UserContext, Depends(require_super_admin())] = None,
