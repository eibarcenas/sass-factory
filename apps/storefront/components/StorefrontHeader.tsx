    ...
    <header className="sticky top-0 z-10 bg-background border-b shadow-sm">
      <div className="max-w-2xl mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-bold text-sm leading-tight">{business.name}</h1>
            <p className="text-xs text-muted-foreground">{business.city}</p>
          </div>
        </div>
        <Button asChild size="sm" className="gap-1.5 bg-green-500 hover:bg-green-600 text-white rounded-full h-8">
