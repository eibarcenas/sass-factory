      ...
      >
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <ul className="flex flex-col gap-3">
              {[
                ...
                <li key={item} className="flex items-start gap-2.5 text-sm" style={{ color: '#888888' }}>
                  <span className="w-1 h-1 rounded-full mt-2 shrink-0" style={{ background: '#25D366' }} aria-hidden="true" />
                  {item}
                </li>
              ))}
            </ul>
            <div className="flex gap-4 mt-2">
              <a href="/es/terminos" className="text-sm underline underline-offset-4" style={{ color: '#888888' }}>
                Terminos y Condiciones
              </a>
              <a href="/es/privacidad" className="text-sm underline underline-offset-4" style={{ color: '#888888' }}>
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              href={`https://wa.me/${process.env.NEXT_PUBLIC_SUPPORT_WHATSAPP ?? '525544712575'}`}
