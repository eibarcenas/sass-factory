...
const COPY = {
  ...
  es: {
    ...
    unitMonth: 'mes',
    unitYear: 'año',
    annualNote: 'Equivale a $75/mes. Ahorras $300 al año.',
    monthlyNote: 'Paga mensual después de tu periodo gratis.',
    urgency: 'Oferta de lanzamiento: 7 días gratis. Sin tarjeta de crédito.',
