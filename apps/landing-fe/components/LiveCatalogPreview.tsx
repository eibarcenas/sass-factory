...
const DEMO_URL = `${STOREFRONT_URL}/demo/heladeria-pinguino`
...
export default function LiveCatalogPreview() {
  return (
    <a
      ...
      className="group relative block w-full max-w-[380px] overflow-hidden rounded-3xl border border-zinc-200 bg-white shadow-[0_28px_80px_rgba(24,24,27,0.14)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_34px_90px_rgba(24,24,27,0.2)]"
    ...
    >
      ...
      <div className="bg-[#fbfbf8] px-5 py-5">
        ...
        <div className="mt-5 flex items-center justify-center gap-2 rounded-2xl bg-zinc-950 px-4 py-3 text-sm font-bold text-white transition-colors group-hover:bg-emerald-600">
