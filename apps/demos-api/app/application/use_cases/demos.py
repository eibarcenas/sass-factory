...
from app.domain.events import DEMOS_DEMO_ACCEPTED_V1
...
def accept_demo(slug: str, email: str, name: str | None) -> dict:
    ...
    publish_event(
        DEMOS_DEMO_ACCEPTED_V1["topic"],
        {
            "eventType": DEMOS_DEMO_ACCEPTED_V1["type"],
            "eventVersion": 1,
            "businessId": slug,
            "ownerEmail": email,
            "ownerName": name,
        ...
        {"eventType": DEMOS_DEMO_ACCEPTED_V1["type"], "businessId": slug},
    )
