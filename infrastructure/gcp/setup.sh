...
echo ""
echo "Next steps:"
echo "  1. Set GCP_PROJECT_ID=$PROJECT_ID in apps/admin/.env"
echo "  2. Set TF_STATE_BUCKET=${PROJECT_ID}-tf-state in apps/admin/.env"
echo "  3. Deploy the admin to Cloud Run:"
echo "     gcloud run deploy sass-factory-admin --source apps/admin --region us-central1"
